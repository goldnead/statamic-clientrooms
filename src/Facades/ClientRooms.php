 ...
 * @method static \Goldnead\ClientRooms\Models\ClientRoomTaskSubmission submitTask(\Goldnead\ClientRooms\Models\ClientRoomTask|int $task, ?string $body = null, array $files = [], ?string $submittedBy = null, array $attributes = [])
 * @method static void removeSubmission(\Goldnead\ClientRooms\Models\ClientRoomTaskSubmission|int $submission)
 * @method static string submissionDownloadUrl(\Goldnead\ClientRooms\Models\ClientRoomTaskSubmissionFile $file)
 ...
 * @method static \Goldnead\ClientRooms\Models\ClientRoomSession recordSession(\Goldnead\ClientRooms\Models\ClientRoom|int $room, string $title, ?\DateTimeInterface $heldAt = null, array $attributes = [])
 * @method static \Goldnead\ClientRooms\Models\ClientRoomSession importSession(\Goldnead\ClientRooms\Models\ClientRoom|int $room, string $externalId, array $attributes = [])
 * @method static \Goldnead\ClientRooms\Models\ClientRoomSession updateSession(\Goldnead\ClientRooms\Models\ClientRoomSession|int $session, array $attributes)
 * @method static \Goldnead\ClientRooms\Models\ClientRoomSession publishSession(\Goldnead\ClientRooms\Models\ClientRoomSession|int $session, bool $published = true)
 * @method static bool removeSession(\Goldnead\ClientRooms\Models\ClientRoomSession|int $session)
