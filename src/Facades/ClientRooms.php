 ...
 * @method static \Goldnead\ClientRooms\Models\ClientRoomTask addTask(\Goldnead\ClientRooms\Models\ClientRoom|int $room, string $title, ?\DateTimeInterface $dueAt = null, ?string $createdBy = null)
