...
class RoomsController extends CpController
{
    ...
    protected function strings(): array
    {
        $keys = [
            ...
            'session_column_when', 'session_column_session', 'session_column_media', 'session_column_visible',
            'session_agenda', 'session_summary', 'session_protocol', 'session_protocol_none',
